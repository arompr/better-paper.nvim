...
local highlights = {
  ...
  NeotestFailed = { fg = red, bold = true },
  NeotestFile = { fg = cyan },
  NeotestFocused = { bold = true, underline = true },
  NeotestIndent = { fg = grey },
  NeotestMarked = { fg = orange, bold = true },
  NeotestNamespace = { fg = purple },
  NeotestPassed = { fg = green, bold = true },
  NeotestRunning = { fg = dark_yellow },
  NeotestSkipped = { fg = cyan },
  NeotestTarget = { fg = red },
  NeotestTest = { link = 'Normal' },
  NeotestUnknown = { link = 'Normal' },
  NeotestWatching = { fg = dark_yellow },
  NeotestWinSelect = { fg = cyan, bold = true },
  -- Notify
